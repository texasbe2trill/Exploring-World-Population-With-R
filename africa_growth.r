...
label_data <- africa_map %>%
  ...
  mutate(
    long = ifelse(region == "Algeria", 1.6596, long),
    lat = ifelse(region == "Algeria", 28.0339, lat),
    ...
    lat = ifelse(region == "Botswana", -22.3285, lat),
    long = ifelse(region == "Burkina Faso", -1.5616, long),
    lat = ifelse(region == "Burkina Faso", 12.6392, lat),
    long = ifelse(region == "Burundi", 29.9189, long),
    lat = ifelse(region == "Burundi", -3.3731, lat),
    long = ifelse(region == "Cabo Verde", -23.0418, long),
    lat = ifelse(region == "Cabo Verde", 16.5388, lat),
    long = ifelse(region == "Cameroon", 12.3547, long),
    lat = ifelse(region == "Cameroon", 7.3697, lat),
    ...
    long = ifelse(region == "Democratic Republic of the Congo", 21.7587, long),
    lat = ifelse(region == "Democratic Republic of the Congo", -4.0383, lat),
    ...
    long = ifelse(region == "Gambia", -15.3101, long),
    lat = ifelse(region == "Gambia", 13.4432, lat),
    long = ifelse(region == "Ghana", -1.0232, long),
    lat = ifelse(region == "Ghana", 7.9465, lat),
    long = ifelse(region == "Guinea", -10.9408, long),
    lat = ifelse(region == "Guinea", 11.1027, lat),
    long = ifelse(region == "Guinea-Bissau", -15.1804, long),
    lat = ifelse(region == "Guinea-Bissau", 11.8037, lat),
    long = ifelse(region == "Ivory Coast", -5.5471, long),
    lat = ifelse(region == "Ivory Coast", 7.5399, lat),
    long = ifelse(region == "Kenya", 37.9062, long),
    lat = ifelse(region == "Kenya", -1.2921, lat),
    long = ifelse(region == "Lesotho", 28.2336, long),
    lat = ifelse(region == "Lesotho", -29.6099, lat),
    ...
    long = ifelse(region == "Namibia", 18.4904, long),
    lat = ifelse(region == "Namibia", -22.9576, lat),
    long = ifelse(region == "Niger", 8.0817, long),
    ...
    long = ifelse(region == "South Africa", 24.9916, long),
    lat = ifelse(region == "South Africa", -28.8166, lat),
    long = ifelse(region == "South Sudan", 31.3060, long),
    ...
    long = ifelse(region == "Western Sahara", -12.8858, long),
